...
---------------
	...
	The App lists my favourite places in my hometown Lucknow,India. There is also a list of the places on the left-side.
	...
	You can filter the list by simply using the input box at the left.

	The app is fully responsive and works in all devices.
